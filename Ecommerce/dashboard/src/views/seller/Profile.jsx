                ...
                <div className='w-full md:w-6/12'>
                    <div className='w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]'>
                      <div className='flex justify-center items-center py-3'>
                          {
                                image ? <label htmlFor="img" className='h-[150px] w-[200px] relative
                                p-3 cursor-pointer overflow-hidden'>
                                <img src="http://localhost:3000/images/demo.jpg" alt="" />
                                        {/*{*/}
                                        {/*    loader && <div className='bg-slate-600 absolute left-0*/}
                                        {/*top-0 w-full h-full opacity-70 flex justify-center*/}
                                        {/*items-center z-20'>*/}
                                        {/*<span>*/}
                                        {/*    <FadeLoader/>*/}
                                        {/*</span>*/}
                        ...
                        <div className='px-0 md:px-5 py-2'>
                          ...
                          bg-slate-800 rounded-md relative'>
                              ...
                              hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer'><FaRegEdit/></span>
                                    ...
                                    <p>
                                        {
                                            ...
                                            text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded'>Pending</span> : <span className='bg-blue-500 text-white
                        ...
                        <div className='px-0 md:px-5 py-2'>
                            {
                                !userInfo ? <form>
                                    <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                                        <label htmlFor="Shop">Shop Name</label>
                                        <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="text" name='shopName' id='Shop' placeholder='Shop Name'/>
                                    </div>
                                    ...
                                    <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                                        ...
                                        <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="text" name='division' id='division' placeholder='Division Name'/>
                                    </div>
                                    ...
                                    <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                                        ...
                                        <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="text" name='district' id='district' placeholder='District Name'/>
                                    </div>
                                    ...
                                    <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                                        ...
                                        <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="text" name='subdis' id='subdis' placeholder='Sub District Name'/>
                                    </div>
                                ...
                                </form> : <div className='flex-justify-between text-sm flex-col gap-2 p-4
                          bg-slate-800 rounded-md relative'>
                              <span className='p-[6px] bg-yellow-500 rounded hover:shadow-lg
                              hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer'><FaRegEdit/></span>
                ...
                <div className='bg-[#6a5fdf] rounded-md text-[#d0d2d6] p-4'>
                    ...
                    <form>
                        <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                            ...
                            <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="email" name='email' id='email' placeholder='email'/>
                        </div>
                        ...
                        <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                            ...
                            <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="password" name='old_password' id='o_password' placeholder='Old Password'/>
                        </div>
                        ...
                        <div className='flex flex-col mb-3 w-full gap-1 mb-2'>
                            ...
                            <input className='px-4 py-2 focus:border-indigo-500
                outline-none bg-[#6a5fdf] border border-slate-700 rounded-md
                text-[#d0d2d6]' type="password" name='new_password' id='n_password' placeholder='New Password'/>
                        </div>
