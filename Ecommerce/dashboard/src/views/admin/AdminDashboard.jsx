        ...
        <div className='px-2 md:px-7 py-5'>
          ...
          md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                text-[#5c5a5a]'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#fa0305] flex
                ...
                text-[#5c5a5a]'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#760077] flex
                  justify-center items-center text-xl '>
                ...
                text-[#5c5a5a]'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#038000] flex
                  justify-center items-center text-xl '>
                ...
                text-[#5c5a5a]'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#0200f8] flex
                  justify-center items-center text-xl '>
                    ...
                    <div className='flex flex-col gap-2 pt-6 text-[#d0d2d6]'>
                        <ol className='relative border-1 border-slate-600 ml-4'>
                            <li className='mb-3 ml-6 '>
                                <div
                                    className='flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6px] bg-[#4c7fe2] rounded-full z-10'>
                                ...
                                sm:mb-0'>2 day ago
                                    ...
                                    <div
                                        className='p-2 text-x font-normal bg-slate-700 rounded-lg border border-slate-800'>
                                        How Are You
                                    </div>
                                </div>
                            </li>
                     ...
                     border-slate-700'>
                      ...
                      <tr>
                        ...
                        <tbody>
                        {
                           ...
                           whitespace-nowrap'>#34344
                                </td>
                                <td scope='row' className='py-3 px-4 font-medium
                           whitespace-nowrap'>$454
                                </td>
                                <td scope='row' className='py-3 px-4 font-medium
                           whitespace-nowrap'>Pending
                                </td>
                                <td scope='row' className='py-3 px-4 font-medium
                           whitespace-nowrap'>Pending
                                </td>
                                <td scope='row' className='py-3 px-4 font-medium
                           whitespace-nowrap'><Link>View</Link>
                                </td>
                            </tr> )
                        }
                        </tbody>
